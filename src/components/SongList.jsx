...
const SongList = () => {
  ...
  useEffect(() => {
    ...
    const sortedSongsByTrackNumber = [...songsWithAverageRating].sort(
      (b, a) => a.trackNumber - b.trackNumber
    );
          ...
          <div className="">
            ...
            >
              <thead className="text-s font-semibold uppercase text-gray-400 bg-gray-50 initial z-40">
                <tr>
                  <th
                    className="p-2 whitespace-nowrap cursor-pointer text-red-700"
